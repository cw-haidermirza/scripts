...
# Point 4: Ask user for action (whitelist or blacklist)
echo "Do you want to (1) Whitelist or (2) Blacklist IPs?"
read -p "Enter 1 for Whitelist, 2 for Blacklist: " action
